...
<div class="bg-colorPrimary/10 h-auto m-0 md:py-24 flex justify-center items-center">
  <div class="bg-black max-w-4xl mx-auto p-6 md:p-12 text-colorLight">
    ...
    <p class="text-sm text-center text-zinc-500">Laatste bijwerking: 17 maart 2025</p>
    ...
    <footer class="mt-8 text-center text-sm text-zinc-500">
      <p>Heb je vragen over ons Privacy Policy? Neem contact met ons op via: <a href="mailto:contact@thesystemoftheworld.com" class="animate-underline animate-text-color theme-primary text-colorLight">contact@thesystemoftheworld.com</a></p>
      <p>
        Wil je de Privacy Policy downloaden voor later gebruik?
        <button id="downloadPPBtn" class="animate-underline animate-text-color theme-primary text-colorLight">
