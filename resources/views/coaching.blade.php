...
<section id="mentorschap" class="relative bg-colorPrimary/10 px-12 py-24 md:py-32 border-t border-b border-zinc-800 overflow-hidden">
    ...
    {{-- HOOFD-CONTAINER VOOR DE AFBEELDING MET RANDGLOED --}}
    {{-- Verwijderde 'rounded-xl' en 'overflow-hidden' om scherpe hoeken te behouden --}}
    {{-- Verwijderde 'w-full max-w-sm mx-auto' wrapper om sizing te respecteren --}}
    <div class="glow-card relative z-0 group">
        
        {{-- DE GLOW BLOB (Z-index 10) --}}
        {{-- De blob moet ONDER de afbeelding staan, maar in dezelfde glow-card. --}}
        <div class="glow-blob z-10"></div> 

        {{-- De Image met zijn overgangseffecten (Z-index 20) --}}
