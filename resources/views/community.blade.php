    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div class="glow-card p-6 text-center">
                <!-- De Glow Blob (JS beweegt deze) -->
                <div class="glow-blob"></div>
                
                <div class="glow-content">
                    <x-lucide-check-circle class="w-12 h-12 text-colorPrimary mx-auto mb-4" />
                    <h3 class="text-lg font-mono text-white mb-2 uppercase tracking-wider">Verantwoordelijkheid</h3>
            ...
            <div class="glow-card p-6 text-center">
                ...
                <div class="glow-content">
                    ...
                    <h3 class="text-lg font-mono text-white mb-2 uppercase tracking-wider">Harde Feedback</h3>
            ...
            <div class="glow-card p-6 text-center">
                ...
                <div class="glow-content">
                    ...
                    <h3 class="text-lg font-mono text-white mb-2 uppercase tracking-wider">Mentale Brandstof</h3>
            ...
            <div class="glow-card p-6 text-center">
                ...
                <div class="glow-content">
                    ...
                    <h3 class="text-lg font-mono text-white mb-2 uppercase tracking-wider">Zonder Oordeel</h3>
