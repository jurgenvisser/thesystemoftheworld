...
@section('title', 'Over Ons')  <!-- Set the title for this page --> {{-- todo: Set the title --}}
    ...
    <div class="h-full flex flex-col">
        <div class="flex-1 flex items-center justify-center flex-col lg:flex-row mt-0 relative">
            ...
            <div class="bg-colorPrimary/60 flex flex-col justify-center items-center p-8 lg:p-20 h-auto w-[85vw] lg:w-auto">
                <h1 class="text-4xl lg:text-9xl text-white font-bold uppercase font-times">Over Ons</h1> {{-- todo Set the title --}}
            </div>
