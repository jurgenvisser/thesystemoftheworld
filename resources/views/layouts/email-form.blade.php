<div class="flex-1 flex items-center justify-center flex-col lg:flex-row mt-0 relative lg:space-x-10">
    ...
    <div class="bg-systemYellow/60 text-sm lg:text-2xl flex flex-col lg:flex-col justify-between text-white p-8 lg:p-20 py-20 h-auto w-[85vw] lg:w-[40.9vw] text-justify leading-loose relative">
        ...
        <form action="/submit" method="POST" class="space-y-4 flex-1">
            <input
                ...
                name="name"
                placeholder="Uw Naam"
                class="w-full p-2 border border-systemYellow rounded focus:outline-none focus:ring focus:ring-systemYellow bg-black/40"
            />
            <input
                type="email"
                name="email"
            ...
            <button
                type="submit"
                class="bg-black text-white rounded hover:ring hover:ring-systemYellow py-2 px-4 hover:bg-gray-800"
            >
                Verstuur
            </button>
        </form>
