...
<div class="h-auto lg:h-full col-span-6">
    <div class="bg-colorPrimary/60 text-sm lg:text-2xl flex flex-col justify-start items-start text-colorLight p-8 lg:p-20 responsive-height text-left lg:text-justify">
        ...
        <form action="https://formsubmit.co/contact@thesystemoftheworld.com" method="POST" class="space-y-2 lg:space-y-4 flex-1 w-full">
            ...
            <input type="hidden" name="_next" value="thesystemoftheworld.com/contact">
            ...
            <div class="lg:flex items-center lg:gap-4">
                ...
                >
                    <option value="geen-voorkeur" disabled selected>Van wie wil je antwoord?</option>
