...
<section id="cta" class="px-6 py-20 bg-black border-t border-b border-zinc-800">
    <div class="max-w-5xl mx-auto text-center">
        ...
        <a href="https://cal.com/thesystem/kennismaking-met-quinn" class="inline-block px-10 py-5 font-mono text-sm uppercase bg-colorPrimary text-black font-bold hover:bg-colorPrimary/80 transition-all">
