    ...
    <a href="{{ $discordInviteLink }}" target="_blank" class="block">
        <div class="relative h-16 lg:h-32 bg-black/30 lg:bg-black/40 text-white flex items-center overflow-hidden">
            ...
            <div class="scrolling-banner absolute whitespace-nowrap flex items-center">               
                {{-- <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-8 lg:pr-16">Mentale helderheid</span> --}}
                ...
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-4 lg:pr-8">Mentale helderheid</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-4 lg:pr-8">•</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-4 lg:pr-8">Discipline</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-4 lg:pr-8">•</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-8 lg:pr-8">Focus</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-4 lg:pr-8">•</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-8 lg:pr-8">Groei</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-4 lg:pr-8">•</span>
                <span class="inline-block text-base text-white lg:text-2xl font-semibold pr-8 lg:pr-16">Rust in je hoofd</span>
                <div class="flex items-center mr-8 lg:mr-16 gap-2 lg:gap-4">
                    <div class="bg-black rounded-full w-10 lg:w-20 h-10 lg:h-20 flex items-center justify-center">
                        <span class="inline-block w-6 lg:w-14 h-6 lg:h-14 bg-the-system-horse bg-cover rounded-lg items-center justify-center"></span>
                    </div>
