...
<div class="w-full xl:w-auto border-b border-colorPrimary/90 xl:border-none flex justify-center">
    <a href="/" aria-label="Main homepage link" class="2xl:animate-underline animate-text-color text-lg lg:text-base 2xl:base font-semibold uppercase py-2 xl:py-0 theme-primary text-center">
        Homepage
    </a>
</div>
<div class="w-full xl:w-auto border-b border-colorPrimary/80 xl:border-none flex justify-center">
    <a href="https://shop.thesystemoftheworld.com" class="2xl:animate-underline animate-text-color text-lg lg:text-base 2xl:text-base font-semibold uppercase py-2 xl:py-0 theme-primary text-center">
        Webshop
    </a>
</div>
