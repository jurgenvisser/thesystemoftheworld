<div class="bg-black h-16 items-center justify-between px-4 sm:px-8 text-gray-200 sticky top-0 z-50 hidden xl:flex">
...
<div id="testing-menu" class="xl:hidden w-full bg-black text-gray-200 fixed top-16 left-0 hidden max-h-screen overflow-y-auto z-40">
